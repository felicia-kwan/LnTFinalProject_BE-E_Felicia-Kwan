...
<div class="banner p-4 mb-3 mt-4 rounded-3 bg-light" style="margin-left: 50px; margin-right: 50px;">
    <h1 style="font-weight: bold; color: black"><i class="uil uil-store"></i> Selamat Datang di Meiying Shop!</h1>
    <br>
    <p class="mb-4">Di website ini anda dapat mengecek dan membeli barang pada etalase. Selamat berbelanja! Terima
        kasih! </p>
</div>
...
<div class="container" style="margin-left: 50px; margin-right: 50px;">
    <form action="" class="search-bar" style="width: 300px; right: 0; display: flex">
        <div class="search" style="display: flex; justify-self: flex-end; align-self: flex-end">
            <input class="form-control me-2" name="search" type="search" placeholder="Cari nama barang"
                aria-label="Search">
