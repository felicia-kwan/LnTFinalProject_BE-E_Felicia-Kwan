...
<div class="home-container mt-5">
    ...
    {{-- MENU BAR --}}
    <header>
        <h2 style="font-weight: bold"><i class="uil uil-apps"></i>Manage Barang</h2>
    </header>
    <div class="header-hr">
        <div class="add-button">
            <a href="{{route('getCreate')}}" class="btn btn-dark btn-lg mb-4" style="font-weight: bold">Add Barang</a>
        </div>
    </div>
    <br><br>
                    ...
                    <div class="col-md-3 mb-5">
                        <div class="card col-md-12 tea-content bg-light p-2">
                            ...
                            <a href="{{route('getUpdate',['id'=>$barang->id])}}"
                                class="btn btn-success btn-lg" style="font-weight: bold">Update</a>
